        ...
        <div id="profile" class="tab-pane fade in active">
            ...
            <div class="row" style="margin-right: -15px;">
                <div class="col-sm-8 box-about">
                    ...
                    <p>We are a family run professional decorating and refurbishment company, who undertake all aspects of painting, decorating, and full property maintenance, kitchens/ bathrooms & insurance work.</p>
                    <p>We are described as always on our toes with good management of time and able to get the job done fast and efficiently. </p>
                </div>

                <div class="col-sm-4">
                    <div class=" box-image">
                        <a data-toggle="tab" href="#reviews"><img src="/easytrade/assets/img/room1.svg" class="img-responsive" alt="Room example"/></a>
                    </div>
            ...
            <div class="row">
                <a data-toggle="tab" href="#contact">
                    <div class="col-sm-12 call-to-action-img" style="background-image: url('/easytrade/assets/img/room4.svg');">
                        <div class="overlay"></div>
                        <h3>CONTACT FOR A QUOTE TODAY!</h3>
                    </div>
                </a>
            </div>
        </div>
